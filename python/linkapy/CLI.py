...
@click.option('--regions', '-r', type=click.Path(exists=True), multiple=True, help='Path to regions file to aggregate methylation data over. Can be specified multiple times.')
